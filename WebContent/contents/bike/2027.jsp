...
<! DOCTYPE html>
    ...
    <title>バイク燃費.com-FLHTCU103ULTRACLASSICELECTRAGLIDEの燃費-</title>
    <!--    googleFontのWebFontをimport-->
    <link href="https://fonts.googleapis.com/css?family=Noto+Serif+JP" rel="stylesheet">
    <meta name="description" content="バイク好きのための燃費登録サイトです！！このページはFLHTCU103ULTRACLASSICELECTRAGLIDEの燃費一覧です。FLHTCU103ULTRACLASSICELECTRAGLIDEを所有するユーザーから投稿された燃費一覧を確認できます！あなたもバイク燃費.comで愛車のバイクの燃費を登録しませんか？">
...
<body>
    ...
    <h1 class=PageTitle_login><br /><br />-FLHTCU103ULTRACLASSICELECTRAGLIDE の燃費-</h1>
    <input type="hidden" id="bike_id" value="2027">
