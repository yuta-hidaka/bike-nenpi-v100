...
<! DOCTYPE html>
    ...
    <title>バイク燃費.com-ClassicMilitary500EFIの燃費-</title>
    <!--    googleFontのWebFontをimport-->
    <link href="https://fonts.googleapis.com/css?family=Noto+Serif+JP" rel="stylesheet">
    <meta name="description" content="バイク好きのための燃費登録サイトです！！このページはClassicMilitary500EFIの燃費一覧です。ClassicMilitary500EFIを所有するユーザーから投稿された燃費一覧を確認できます！あなたもバイク燃費.comで愛車のバイクの燃費を登録しませんか？">
...
<body>
    ...
    <h1 class=PageTitle_login><br /><br />-ClassicMilitary500EFI の燃費-</h1>
    <input type="hidden" id="bike_id" value="3139">
