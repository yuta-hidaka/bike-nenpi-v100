...
<! DOCTYPE html>
    ...
    <title>バイク燃費.com-RUNNER180FXR-SPの燃費-</title>
    <!--    googleFontのWebFontをimport-->
    <link href="https://fonts.googleapis.com/css?family=Noto+Serif+JP" rel="stylesheet">
    <meta name="description" content="バイク好きのための燃費登録サイトです！！このページはRUNNER180FXR-SPの燃費一覧です。RUNNER180FXR-SPを所有するユーザーから投稿された燃費一覧を確認できます！あなたもバイク燃費.comで愛車のバイクの燃費を登録しませんか？">
...
<body>
    ...
    <h1 class=PageTitle_login><br /><br />-RUNNER180FXR-SP の燃費-</h1>
    <input type="hidden" id="bike_id" value="3310">
