...
<! DOCTYPE html>
    ...
    <title>バイク燃費.com-PC800パシフィックコーストの燃費-</title>
    <!--    googleFontのWebFontをimport-->
    <link href="https://fonts.googleapis.com/css?family=Noto+Serif+JP" rel="stylesheet">
    <meta name="description" content="バイク好きのための燃費登録サイトです！！このページはPC800パシフィックコーストの燃費一覧です。PC800パシフィックコーストを所有するユーザーから投稿された燃費一覧を確認できます！あなたもバイク燃費.comで愛車のバイクの燃費を登録しませんか？">
...
<body>
    ...
    <h1 class=PageTitle_login><br /><br />-PC800パシフィックコースト の燃費-</h1>
    <input type="hidden" id="bike_id" value="600">
