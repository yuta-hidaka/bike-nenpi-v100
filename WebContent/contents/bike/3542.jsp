...
<! DOCTYPE html>
    ...
    <title>バイク燃費.com-FE400eの燃費-</title>
    <!--    googleFontのWebFontをimport-->
    <link href="https://fonts.googleapis.com/css?family=Noto+Serif+JP" rel="stylesheet">
    <meta name="description" content="バイク好きのための燃費登録サイトです！！このページはFE400eの燃費一覧です。FE400eを所有するユーザーから投稿された燃費一覧を確認できます！あなたもバイク燃費.comで愛車のバイクの燃費を登録しませんか？">
...
<body>
    ...
    <h1 class=PageTitle_login><br /><br />-FE400e の燃費-</h1>
    <input type="hidden" id="bike_id" value="3542">
