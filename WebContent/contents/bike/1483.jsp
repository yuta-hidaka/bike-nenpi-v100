...
<! DOCTYPE html>
    ...
    <title>バイク燃費.com-XF650フリーウインドの燃費-</title>
    <!--    googleFontのWebFontをimport-->
    <link href="https://fonts.googleapis.com/css?family=Noto+Serif+JP" rel="stylesheet">
    <meta name="description" content="バイク好きのための燃費登録サイトです！！このページはXF650フリーウインドの燃費一覧です。XF650フリーウインドを所有するユーザーから投稿された燃費一覧を確認できます！あなたもバイク燃費.comで愛車のバイクの燃費を登録しませんか？">
...
<body>
    ...
    <h1 class=PageTitle_login><br /><br />-XF650フリーウインド の燃費-</h1>
    <input type="hidden" id="bike_id" value="1483">
