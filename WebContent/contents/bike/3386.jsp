...
<! DOCTYPE html>
    ...
    <title>バイク燃費.com-Evo2T300の燃費-</title>
    <!--    googleFontのWebFontをimport-->
    <link href="https://fonts.googleapis.com/css?family=Noto+Serif+JP" rel="stylesheet">
    <meta name="description" content="バイク好きのための燃費登録サイトです！！このページはEvo2T300の燃費一覧です。Evo2T300を所有するユーザーから投稿された燃費一覧を確認できます！あなたもバイク燃費.comで愛車のバイクの燃費を登録しませんか？">
...
<body>
    ...
    <h1 class=PageTitle_login><br /><br />-Evo2T300 の燃費-</h1>
    <input type="hidden" id="bike_id" value="3386">
