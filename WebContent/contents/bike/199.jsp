...
<! DOCTYPE html>
    ...
    <title>バイク燃費.com-ノバテナ110/RSの燃費-</title>
    <!--    googleFontのWebFontをimport-->
    <link href="https://fonts.googleapis.com/css?family=Noto+Serif+JP" rel="stylesheet">
    <meta name="description" content="バイク好きのための燃費登録サイトです！！このページはノバテナ110/RSの燃費一覧です。ノバテナ110/RSを所有するユーザーから投稿された燃費一覧を確認できます！あなたもバイク燃費.comで愛車のバイクの燃費を登録しませんか？">
...
<body>
    ...
    <h1 class=PageTitle_login><br /><br />-ノバテナ110/RS の燃費-</h1>
    <input type="hidden" id="bike_id" value="199">
