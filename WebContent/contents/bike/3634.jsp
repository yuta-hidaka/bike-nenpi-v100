...
<! DOCTYPE html>
    ...
    <title>バイク燃費.com-Jbubu125duosの燃費-</title>
    <!--    googleFontのWebFontをimport-->
    <link href="https://fonts.googleapis.com/css?family=Noto+Serif+JP" rel="stylesheet">
    <meta name="description" content="バイク好きのための燃費登録サイトです！！このページはJbubu125duosの燃費一覧です。Jbubu125duosを所有するユーザーから投稿された燃費一覧を確認できます！あなたもバイク燃費.comで愛車のバイクの燃費を登録しませんか？">
...
<body>
    ...
    <h1 class=PageTitle_login><br /><br />-Jbubu125duos の燃費-</h1>
    <input type="hidden" id="bike_id" value="3634">
