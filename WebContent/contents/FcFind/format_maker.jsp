...
<!--スマホで見やすいように準備します。↓-->
    ...
    <title>バイク燃費.com-[name]の燃費-</title>
  ...
  .always(function( jqXHR, textStatus ) {
        ...
        '<tr>'+
            ...
            '<th   colspan=2  class="FC_Check_Show_td_th">'+
               ...
               '<p><span id="city_ride2"></span>'+list.high_way_ride+'%/<span id="high_way_ride2"></span>'+list.city_ride+'%</p>'+
           '</th>'+
        '</tr>'+
...
<h2 class=PageTitle_login><br/><br/>-<span id="bike_name1"></span>の燃費-</h2>
<input type="hidden" id="bike_id" value="[id]" >
