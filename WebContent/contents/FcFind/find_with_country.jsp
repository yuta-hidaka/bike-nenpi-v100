       ...
       <!--------------------------------test---------------------------------->
        ...
        <tr>
            <td class="search_maker_td">
                <form action="/bikeNenpi/FC_Find"method="post">
                <input type="hidden" name="country_id" value="<%=list.get(i).getCountry_id() %>">
                <input type="submit" value="<%=list.get(i).getCountry_name() %>" class="serch_maker">
                <input type="hidden"  name="fc_find_process_flg" value="6" id="find">
                </form>
            </td>
            <td class="search_maker_td">
            </td>
...
%>
        ...
        <tr>
            ...
            <td class="search_maker_td">
                <form action="/bikeNenpi/FC_Find"method="post">
                <input type="hidden" name="country_id" value="<%=list.get(i+1).getCountry_id() %>">
                <input type="submit" value="<%=list.get(i+1).getCountry_name() %>" class="serch_maker">
                <input type="hidden"  name="fc_find_process_flg" value="6" id="find">
                </form>
            </td>
        </tr>
